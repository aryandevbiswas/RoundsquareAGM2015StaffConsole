...
#Round Square AGM 2015 Staff Console Ver 1.3-beta (Linux,Chrome)	#
#################################################################
...
Create a directoty StaffConsoleChrome inside the .RSAGM2015 folder
and extract the archive contents there

Right Click on the start.sh file and set permissons to "Allow executing
file as program".

Copy and paste the RSAGM2015StaffConsoleChrome.desktop file at your
